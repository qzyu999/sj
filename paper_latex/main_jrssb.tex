...
% Fix OUP cls v1.5 bugs: \authormark and \societylogo used but undefined
\makeatletter
...
\author[1,$\ast$]{Jared Yu}

\authormark{Yu}

\address[1]{\orgname{Independent Researcher}, \orgaddress{\country{United States}}}

\corresp[$\ast$]{Corresponding author. email@example.com}

%\received{Date}{0}{Year}
%\revised{Date}{0}{Year}
%\accepted{Date}{0}{Year}

\abstract{We derive a closed-form expression for the integrated squared Laplacian roughness of an isotropic multivariate Gaussian kernel density estimator, enabling non-iterative bandwidth selection in any dimension.}

\keywords{bandwidth selection, kernel density estimation, plug-in method, multivariate, nonparametric}

% DEBUG: provide any missing commands
\providecommand{\access}[1]{}
\providecommand{\appnotes}[1]{}
...
\section*{Appendix: Moment calculations}\label{app:moments}
