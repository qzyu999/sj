...
%\FMAUBIO{\color{black!20}\rule{37pt}{37pt}\color{black}}{\author{Author Name.} This is sample author biography text for journals which include this element in the front matter. The values provided in the optional argument are meant for sample purposes. There is no need to include the width and height of an image in the optional argument for live articles. Check the journal's online author guidelines to see if this element is required.}

%\FMAUBIO{\color{black!20}\rule{37pt}{37pt}\color{black}}{\author{Author Name.}  This is sample author biography text in the front matter. The values provided in the optional argument are meant for sample purposes. There is no need to include the width and height of an image in the optional argument for live articles. This is sample author biography text for journals which include this element in the front matter. The values provided in the optional argument are meant for sample purposes. There is no need to include the width and height of an image in the optional argument for live articles. Check the journal's online author guidelines to see if this element is required.}
